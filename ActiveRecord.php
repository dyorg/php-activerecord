...
require __DIR__.'/lib/ModelCollection.php';
require __DIR__.'/lib/Table.php';
require __DIR__.'/lib/ConnectionManager.php';
require __DIR__.'/lib/Connection.php';
require __DIR__.'/lib/Serialization.php';
require __DIR__.'/lib/Serialization/ArrayCollectionSerializer.php';
require __DIR__.'/lib/Serialization/CollectionSerializer.php.php';
require __DIR__.'/lib/Serialization/CsvCollectionSerializer.php.php';
require __DIR__.'/lib/Serialization/JsonCollectionSerializer.php.php';
